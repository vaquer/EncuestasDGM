...
var jsonBarchart;
    ...
    var margin = {top: (parseInt(d3.select('#bar-chart').style('height'), 10)/20), right: (parseInt(d3.select('.contenedor-tabla').style('width'), 10)/20), bottom: (parseInt(d3.select('.contenedor-tabla').style('height'), 10)/20), left: (parseInt(d3.select('.contenedor-tabla').style('width'), 10)/10)},
    width = parseInt(d3.select('.contenedor-tabla').style('width'), 10) - margin.left - margin.right,
    height = parseInt(d3.select('.contenedor-tabla').style('height'), 10) - margin.top - margin.bottom;
    ...
    bar.on("mousemove", function(d){
      divTooltip.style("left", d3.event.pageX - 200+"px");
